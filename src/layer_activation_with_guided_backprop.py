...
The method is quite similar to guided backpropagation but instead of guiding the signal from the last
layer and a specific target, it guides the signal from a specific layer and filter.

xk: refer to
Deep Inside Convolutional Networks: Visualising Image Classification Models and Saliency Maps, ICLR2014
https://arxiv.org/abs/1312.6034
Here "computes salience map" for the selected layer and filter, rather than the class. Need one backward.
