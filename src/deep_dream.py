...
xk: Here "generates image" for the selected layer and filter, rather than the class. Need several backwards.
Start from specific image as input
related to my_feature_model_vis (not implemented in this repo, refer to my_class_model_vis if necessary)
"""
import os
...
class DeepDream():
    ...
    def __init__(self, model, selected_layer, selected_filter, im_path):
        ...
        self.conv_output = 0
        # Generate a random image --> xk: use a real picture
    ...
    def dream(self):
        ...
        for i in range(1, 201):
            ...
            loss = -torch.mean(self.conv_output)    # xk: equal to do backward of feat_map
            ...
            if i % 10 == 0:
                ...
                im_path = '../results/generated/ddream_l' + str(self.selected_layer) + \
...
if __name__ == '__main__':
    ...
    pretrained_model = models.vgg19(pretrained=True).features  # xk: Downloading to /root/.cache/torch/checkpoints/vgg19-dcbb9e9d.pth
