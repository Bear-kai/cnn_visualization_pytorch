...
from src_1.vanilla_backprop import VanillaBackprop
...
def generate_smooth_grad(Backprop, prep_img, target_class, param_n, param_sigma_multiplier):
    ...
    for x in range(param_n):
        # Generate noise        # xk: new() constructs a tensor with the same dtype
...
if __name__ == '__main__':
    ...
    # if you want to use GBP dont forget to change the parametre in generate_smooth_grad
